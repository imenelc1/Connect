...
export default function HeroSection() {
  ...
  <Button
    ...
    className="w-auto px-6 sm:px-8 md:px-12 py-2 md:py-2 bg-primary text-white rounded-xl font-medium shadow hover:opacity-90 transition flex items-center gap-2"
  >
    <FaPaperPlane className="text-white text-lg" size={16} />
    {t("acceuil.button_start")}
  </Button>
