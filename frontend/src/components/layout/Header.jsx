...
export default function Header() {
  return (
    <header className="bg-[var(--color-bg)] min-h-screen flex flex-col justify-between px-8 py-0 md:px-16">
      <Navbar />
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mt-20 md:mt-32">
        <div className="max-w-xl space-y-6">
          ...
          <div className="flex space-x-4">
            <Button className=" bg-[var(--color-primary)] text-white px-12 py-2 rounded-xl font-medium shadow hover:opacity-90 transition ">
            Get Started
            </Button>
