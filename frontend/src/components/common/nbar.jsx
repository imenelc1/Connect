...
import {
  Settings, LogOut, Home, BookOpen, Users, Clipboard, Activity, MessageCircle, FileText
} from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <aside
      className="w-60 h-screen rounded-3xl shadow-2xl p-4 flex flex-col justify-between fixed top-0 left-0"
      style={{ background: "var(--color-surface)" }}
    >
      {/* Header profil */}
      <div className="flex items-center gap-2.5 p-2.5 rounded-2xl shadow-sm" style={{ background: "var(--color-surface)" }}>
        <div
          className="w-10 h-10 flex items-center justify-center rounded-full text-white font-semibold text-base"
