...
export default function Button({
  ...
  const variants = {
   ...
   Setting: `${base} shadow-md rounded-3xl font-bold font-poppins
             bg-primary
             text-xl sm:text-xl md:text-xl hover:opacity-90 text-white
             flex w-fit items-center justify-center gap-3 px-4 py-2`,
