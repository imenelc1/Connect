        ...
        <div className="  flex w-full md:flex-row min-h-screen">
            ...
            <div className="flex-1 p-4 p-4 sm:p-6 md:p-8 lg:p-10">
                    ...
                    <div className="mt-10 bg-primary/ backdrop-blur-md rounded-3xl shadow-md p-6 sm:p-6 md:p-8  border border-white/40">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                            ...
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2">{t("Profile.FullName")}</label>
                                <div className="relative">
                                    <UserRound className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                                    <input
                                        type="text"
                                        className="w-full pl-10 bg-white border border-gray-200 rounded-xl p-3 shadow-sm"
                            ...
                            {/* Nickname */}
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2"> {t("Profile.NickName")}</label>
                                <div className="relative">
                            ...
                            {/* Date */}
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2">{t("Profile.Datebirth")}</label>
                                <input
                                    type="date"
                                    className="w-full pl-10 bg-white border border-gray-200 rounded-xl p-3 shadow-sm"
                                />
                            ...
                            {/* Email */}
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2">{t("Profile.EmailAddress")}</label>
                                <div className="relative">
                            ...
                            {/* Registration */}
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2">{t("Profile.RegistratioNumber")}</label>
                                <div className="relative">
                            ...
                            {/* Grade */}
                            <div className="flex flex-col">
                                <label className="text-gray-700 mb-2">{t("Profile.Grade")}</label>
                                <div className="relative">
                                    <Award className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                                    <select className="w-full pl-10 bg-white border border-gray-200 rounded-xl p-3 shadow-sm">
                                        <option>Grade</option>
                ...
                {activeTab === "preferences" && (
                    <div className="mt-10 p-6  bg-primary/10 sm:p-8 md:p-10 rounded-3xl shadow-md 
                  bg-top-gradient backdrop-blur-xl">
                        ...
                        <div className="mb-10">
                            ...
                            {/* LIGHT MODE */}
                            <label className="flex items-center justify-between bg-white rounded-xl p-4 mb-3 shadow-sm cursor-pointer">
                                <div>
                                    <p className="font-medium text-gray-800">{t("Preferences.LightMode")}</p>
                                    <p className="text-sm text-gray-500">{t("Preferences.Brightp")}</p>
                                </div>
                            ...
                            {/* DARK MODE */}
                            <label className="flex items-center justify-between bg-white rounded-xl p-4 shadow-sm cursor-pointer">
                                <div>
                                    <p className="font-medium text-gray-800">{t("Preferences.DarkMode")}</p>
                                    <p className="text-sm text-gray-500">{t("Preferences.Easyp")}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <select
                                className="w-full bg-white rounded-xl p-3 shadow-sm border border-gray-200"
                                value={i18n.language}
                ...
                {/* -------- ACCOUNT -------- */}
                {activeTab === "account" && (
                    <div className="mt-4 p-6 sm:p-8 md:p-10 rounded-3xl shadow-md 
                  bg-top-gradient backdrop-blur-xl">
                        ...
                        <div className="bg-primary/10 rounded-2xl p-6 shadow-sm border border-white/40 mb-10">
                            ...
                            <div className="flex flex-col mb-4">
                                <label className="text-gray-700 mb-2">  {t("Account.CurrentPassword")}</label>
                                <input
                                    type="password"
                            ...
                            {/* New Password */}
                            <div className="flex flex-col mb-4">
                                <label className="text-gray-700 mb-2">  {t("Account.NewPassword")}</label>
                                <input
                                    type="password"
                            ...
                            <div className="flex flex-col mb-6">
                                <label className="text-gray-700 mb-2">  {t("Account.ConfirmNewPassword")}</label>
                                <input
                                    type="password"
