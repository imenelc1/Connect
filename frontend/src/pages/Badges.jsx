...
const badges = [
  ...
  { title: "First Steps", desc: "Complete your first exercise", xp: "+50 XP", category: "progress", locked: false },
  { title: "Problem Solver", desc: "Solve 10 exercises successfully", xp: "+100 XP", category: "success", locked: true },
  { title: "Perfectionist", desc: "Solve 25 exercises without errors", xp: "+150 XP", category: "success", locked: true },
  { title: "Speed Demon", desc: "Solve 5 exercises in under an hour", xp: "+100 XP", category: "special", locked: true },
  { title: "7 Day Streak", desc: "Solve exercises for 7 consecutive days", xp: "+200 XP", category: "special", locked: false },
  { title: "Quiz Novice", desc: "Complete your first quiz", xp: "+50 XP", category: "progress", locked: false },
  { title: "Quiz Whiz", desc: "Score 100% on a quiz", xp: "+100 XP", category: "success", locked: true },
  { title: "Quiz Master", desc: "Finish 10 quizzes", xp: "+150 XP", category: "success", locked: true },
  { title: "Curious Mind", desc: "Answer 50 total quiz questions", xp: "+100 XP", category: "progress", locked: true },
  { title: "AI Learner", desc: "Use the AI explanation feature for the first time", xp: "+50 XP", category: "special", locked: false },
  { title: "All-Rounder", desc: "Complete one course, one exercise, and one AI analysis", xp: "+150 XP", category: "special", locked: true },
  { title: "Legendary Coder", desc: "Complete all courses, exercises, and quizzes", xp: "+300 XP", category: "success", locked: true },
  { title: "Active Learner", desc: "Work on the platform 7 consecutive days", xp: "+200 XP", category: "special", locked: false },
  { title: "Night Owl", desc: "Submit an exercise between midnight and 3 a.m.", xp: "+100 XP", category: "special", locked: true },
];

// Function to choose an icon
import { FaMedal, FaLightbulb, FaChartLine, FaTrophy, FaStar, FaRocket, FaFire } from "react-icons/fa";
