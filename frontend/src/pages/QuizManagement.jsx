...
return (
    <div className="flex w-full bg-bg min-h-screen overflow-x-hidden">
        ...
        {/* PAGE CONTENT */}
        <div
            className="flex-1 p-4 md:p-8 ml-0 md:ml-56 transition-all"
            id="page-content"
        >
            {/* HEADER */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5">
                {quizzes
                    .filter((q) =>
                        String(q.exercice).includes(search)
                    )
                    .map((q) => (
                        <div
                            key={q.id}
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-textc text-base">
                                            {t("quiz")} #{q.id}
                                        </h3>
                                        <p className="text-textc text-sm">
                                            {t("exercise")} #{q.exercice}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 grid grid-cols-3 text-center text-sm text-textc">
                                <div>
                                    <span className="text-textc/80 text-m">
                                        {t("stats.minScore")}
                                    </span>
        ...
        <AddModal
            ...
            fields={[
                {
                    label: t("modal.fields.minScore"),
                    placeholder: "0",
                    value: newQuiz.scoreMinimum,
                    onChange: (e) =>
                        setNewQuiz({
                            ...newQuiz,
                            scoreMinimum: e.target.value,
                        }),
                },
                {
                    label: t("modal.fields.maxAttempts"),
                    placeholder: "0",
                    value: newQuiz.nbMax_tentative,
                    onChange: (e) =>
                        setNewQuiz({
                            ...newQuiz,
                            nbMax_tentative: e.target.value,
                        }),
                },
            ]}
        />
            ...
            fields={
                selectedQuiz
                    ? [
                          ...
                          {
                              label: t("modal.fields.maxAttempts"),
                              value: editValues.nbMax_tentative,
                              onChange: (e) =>
                                  setEditValues({
                                      ...editValues,
                                      nbMax_tentative: e.target.value,
