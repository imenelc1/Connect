      ...
      <div className="flex-1 ml-56 p-8">
        ...
        <div className="bg-card shadow-lg rounded-3xl p-5 mb-8 border border-blue/20">
          <div className="mb-4">
            ...
            <Input
              placeholder={t("forum.forumPlaceholder")}//"Donnez un titre à votre discussion"  
              value={newPostTitle}
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              {t("forum.forumMessage")}
            </label>
            <textarea
              placeholder={t("forum.forumMessagePlaceholder")}//"Écrivez votre message..." 
            ...
            <p className="text-xs text-textc mt-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  <div className="text-left">
                    <div className="font-medium">{t("forum.forENS")} {/*Aux enseignants */}</div>
                ...
                >
                  <div className="text-left">
                    <div className="font-medium">    {t("forum.forSTD")}{/*Aux étudiants*/} </div>
                    <div className="text-xs mt-1 opacity-80">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="text-sm text-grayc">
              {t("forum.postedby")} <span className="font-semibold">{initials}</span>
              <span className="ml-2 px-2 py-1 text-xs bg-blue/10 text-blue rounded">
                {role === "enseignant"
                  ? t("forum.role.teacher")
                  : t("forum.role.student")
                }
        ...
        <div className="space-y-6">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold mb-2"> {t("forum.forumInfo")} </h3> {/* Aucun forum */}
              <p className="text-grayc mb-6">{t("forum.forumInfoMessage")}</p>  {/*Soyez le premier à créer un forum ! */}
            </div>
          ) : (
            finalPosts.map((post) => (
                      ...
                      <span>
                        ...
                        <span>
                          {expandedForums[post.id]
                            ? t("forum.hideMessages")
                            : t("forum.showMessages", { count: messages[post.id]?.length - 1 || 0 })}
                        </span>
               ...
               disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                      ...
                      {showDeleteConfirm === post.id && (
                        <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-red-200 p-4 z-10">
                          <div className="flex items-start gap-3 mb-4">
                            ...
                            <div>
                              <h4 className="font-semibold text-gray-800"> {t("forum.delete")}  {/*Supprimer ce forum ? */}</h4>
                              <p className="text-sm text-gray-600 mt-1">
                                {t("forum.deleteAction")}
                ...
                <div className="mt-4">
                  <div className="flex items-center space-x-2">
                    <Input
                      placeholder={t("repForum.repF")} //"Écrivez votre réponse..."
                ...
                {expandedForums[post.id] && messages[post.id]?.length > 1 && (
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <h4 className="text-lg font-semibold mb-4 text-gray-700">
                      {t("repForum.replies", { count: messages[post.id].length - 1 })}
                    </h4>
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="mt-4">
                                    ...
                                    >
                                      ...
                                      <span>
                                        {t("repForum.comments", { count: message.nombre_commentaires || 0 })}
                                      </span>
