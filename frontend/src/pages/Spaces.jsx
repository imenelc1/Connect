...
export default function SpacesPage() {
  ...
  return (
    <div className="flex flex-col justify-end items-end w-full min-h-screen bg-surface pr-5 pt-3">
      {/* ====== Header : titre + icônes sur la même ligne ====== */}
        ...
        <div className="flex-1 p-4 sm:p-6 ml-0 lg:ml-56 transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-6">
            {/* Bouton ouvrant le modal */}
              ...
              <Button
              variant="primary"
              className="!px-4 !py-2 !text-white !w-auto sm:!w-auto ml-[810px] whitespace-nowrap"
