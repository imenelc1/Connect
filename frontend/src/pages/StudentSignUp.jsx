...
import { FaUser, FaEnvelope, FaLock, FaCalendarAlt, FaIdBadge, FaGraduationCap, FaPaperPlane, FaEye, FaEyeSlash } from "react-icons/fa";
...
const StudentSignup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-0" style={{ backgroundColor: "#f5f9fd" }}>
      {/* Header */}
      <div className="w-full max-w-6xl flex items-center justify-center relative py-5">
        {/* Logo à gauche */}
        ...
        <div className="flex-1 p-10 bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Input label="Enter your name" name="fullname" value={formData.fullname} onChange={handleChange} placeholder="Full name" icon={<FaUser />} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Input label="Enter your field of study" name="field" value={formData.field} onChange={handleChange} placeholder="Field of study" icon={<FaGraduationCap />} />
              <Select label="Enter your academic year" name="year" value={formData.year} onChange={handleChange} icon={<FaGraduationCap />} options={["L1","L2","L3","Ingenieur"]} />
            </div>
