...
export default function CreateQuiz() {
  ...
  return (
    <div className="flex min-h-screen" style={{ background: "rgb(var(--grad-5)))" }}>
      
      {/* LOGO FIXE */}
      <div className="fixed -top-11 left-6 z-50 w-28 md:w-32">
        <Logo />
      </div>
      ...
      {/* MAIN CONTENT */}
      <div className="flex-1 p-4 lg:ml-60 mt-16 lg:mt-0">
        <div className="max-w-7xl mx-auto">

          {/* HEADER */}
          <div className="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <h1 className="text-xl md:text-2xl font-bold" style={{ color: "rgb(var(--color-primary))" }}>
              {t("newQuiz")}
            </h1>
            <button
          ...
          {/* MAIN GRID */}
          <div
            className="rounded-2xl shadow-lg p-6 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:ml-20"
