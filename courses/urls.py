...
from .views import CoursListCreateView, CoursesWithProgressView, MarkLessonVisitedView, UpdateLeconView,  CreateSectionView, CourseDetailView, CreateLeconView,  CreateCoursView, CoursDetailView, SectionListCreateView, LeconListCreateView, SectionDetailView, LeconDetailView, update_course_status
from django.urls import path
